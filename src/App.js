...
import ProductManagementComponent from './containers/pages/ProductManagementComponent';
    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          <Route exact path='/dashboard/product' element={<ProductManagementComponent/>}/>
